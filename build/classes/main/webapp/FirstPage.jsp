...
<h1>Connexion de compte recruteur</h1>
...
<div class="cont_ba_opcitiy">
  ...
  <p>Si vous n'avez pas de compte vous devez le creer en cliquant sur sign up et en suivant les étapes </p>

  <button  class="btn"> 
  
  <a href="Inscrecruteur">SIGN UP</button>
</div>
  </div>
       </div>
